...
<html lang="en">
    <head>
        ...
        <title>Fptshop.com.vn | Điện thoại</title>
            ...
            <div class="table-wrapper">
                ...
                <div class="table-title">
                    <div class="btn-container">
                        <a href="home" style="display: inline-block; padding: 10px 20px; font-size: 18px; color: #fff; background-color: #007bff; border: none; border-radius: 5px; text-decoration: none; transition: background-color 0.3s ease;">Back to home</a>
                    </div>
                    <div class="row">
